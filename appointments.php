...
<html>
  ...
  <header class="avatar">
    ...
    <li tabindex="0" class="icon-settings text-uppercase active"><a href="appointments.php"><span><span class="fa fa-newspaper"></span> Appointments</span></a></li>
...
<main>
	<nav class="top-nav">
		<div class="row">
			<div class="col-md-4">
				<h4 class="header-text mt-4 "> <span class="fa fa-newspaper"></span> MANAGE APPOINTMENTS</h4>
			</div>
    ...
    <!-- Begining of Tab -->
      ...
      <ul class="nav nav-tabs tab-header" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" href="#home2" role="tab"> <span class="fa fa-align-justify"></span>  APPOINTMENTS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span class="fa fa-plus"></span> ADD APPOINTMENT</a>
        </li>
      </ul>
        ...
        <div class="tab-pane fade bg-color" id="profile2" role="tabpanel">
        	...
        	<div class="form-tab mx-auto">
        		<div class="form-padding">
        			<form class="form-horizontal" role="form" action="appointmentsinsert.php" method="post">
        				<div class="form-group">
        					<div class="col-sm-10 ">
        						<input type="date" class="form-control" id="appointment" name="appointment" placeholder="Date of Appointment">
        					</div>
        				</div>
        				<div class="form-group">
        					<div class="col-sm-10 ">
