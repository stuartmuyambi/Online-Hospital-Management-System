...
<html>
  ...
  <header class="avatar">
    ...
    <li tabindex="0" class="icon-users text-uppercase active"><span><span class="fa fa-user-md"></span> Doctor</span></li>
...
<main>
	<nav class="top-nav">
		<div class="row">
			<div class="col-md-4">
				<h4 class="header-text mt-4 "> <span class="fa fa-user-md"></span> MANAGE DOCTORS</h4>
			</div>
    ...
    <!-- Begining of Tab -->
      ...
      <ul class="nav nav-tabs tab-header" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" href="#home2" role="tab"> <span class="fa fa-align-justify"></span>  DOCTOR LIST</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span class="fa fa-plus"></span> ADD DOCTOR</a>
        </li>
      </ul>
        ...
        <div class="tab-pane fade bg-color" id="profile2" role="tabpanel">
        	...
        	<div class="form-tab mx-auto">
        		<div class="form-padding">
        			<form class="form-horizontal" role="form" action="doctorinsert.php" method="post">
        				...
        				<div class="form-group">
        					<div class="col-sm-10 ">
        						<input type="text" class="form-control" id="address" name="address" placeholder="Doctor's Address">
        					</div>
        				</div>
        				<div class="form-group">
        					<div class="col-sm-10 ">
        						<input type="text" class="form-control" id="phone" name="phone" placeholder="Doctor's Phone Number">
        					</div>
        				</div>
        				<div class="form-group">
        					<div class="col-sm-10"> 
        						<input type="text" class="form-control" id="department" name="department" placeholder="Doctor's Department">
        					</div>
        				</div>
        				<div class="bg-button">
