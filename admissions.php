...
<main>
	<nav class="top-nav">
		<div class="row">
			<div class="col-md-4">
				<h4 class="header-text mt-4 "> <span class="fa fa-file-medical-alt"></span> MANAGE ADMISSIONS</h4>
			</div>
	...
	<div class="main-dash">
		...
		<!-- Begining of Tab -->
			...
			<ul class="nav nav-tabs tab-header" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" data-toggle="tab" href="#home2" role="tab"> <span class="fa fa-align-justify"></span>  ADMISSION LIST</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span class="fa fa-plus"></span> ADD ADMISSION</a>
				</li>
			</ul>
				...
				<div class="tab-pane fade bg-color" id="profile2" role="tabpanel">
					...
					<div class="form-tab mx-auto">
						<div class="form-padding">
							<form class="form-horizontal" role="form" action="admissionsinsert.php" method="post">
